...
(() => {
  ...
  window.fetch = async (_0x5e0511, _0x130dfd) => {
    ...
    return _0x20cfe5(_0x2c14a0 || _0x125b1f, _0x2efb4d).then(_0x28cf90 => {
      ...
      //   if(_0x28cf90&&_0x28cf90.ok&&_0x28cf90.status==200){
      //     const contentType = _0x28cf90.headers.get("Content-Type")
      //     if(contentType){
      //       if(contentType.indexOf("json") != -0x1){
      //         let data = _0x28cf90.json()
      //         console.log("window.fetch response===:"+_0x28cf90.json());
      //       }else if(contentType.indexOf("stream") != -0x1){
      //         // console.log("window.fetch response===:"+`${_0x28cf90.arrayBuffer()}`);
      //       }
      //     }
      //   }
      // }
